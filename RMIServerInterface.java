...
public interface RMIServerInterface extends Remote {
    enum ConnResponse { UnsetPolicy, NoSuchObject, NothingToExport };
    ConnResponse ManageConnection(String username, String password, String address, String op) throws RemoteException;
